...
testFont = pygame.font.Font(
    "/Users/djt/Desktop/testing_folder/pygame_testing/font_assets/Pixeltype.ttf", 50)
textSurface = testFont.render('My Game', False, (254, 128, 25))

background = pygame.image.load(
    "/Users/djt/Desktop/testing_folder/pygame_testing/image_assets/sky.png").convert_alpha()
background = pygame.transform.scale(background, (SCREEN_WIDTH, SCREEN_HEIGTH))

grass = pygame.image.load(
    "/Users/djt/Desktop/testing_folder/pygame_testing/image_assets/ground.png")
grass = pygame.transform.scale(grass, (SCREEN_WIDTH, 200))

snail = pygame.image.load(
    "/Users/djt/Desktop/testing_folder/pygame_testing/image_assets/snail/snail1.png").convert_alpha()
snailXPos = 700

player = pygame.image.load(
    "/Users/djt/Desktop/testing_folder/pygame_testing/image_assets/Player/player_walk_1.png").convert_alpha()
